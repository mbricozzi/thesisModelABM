...
;     1.1) There is at least one interesting plot
        [
          ...
          ifelse capital >= (first ([landPrice] of interestingPlots with-max [wineQ])) + totalCost + installCost ; must also count the maintenance cost of the plot you want to buy (there should be an installation cost)
