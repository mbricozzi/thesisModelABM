...
1254
383
If \"ON\" they immediately self select in the first period, all farms in low quality areas die out. They sell all low quality plots in orger to stick to the rule. Not so realistic.\n\nIf \"OFF\" they can only make one iteration of the loop per period. (Check the attached model diagram).
8
0.0
1
...
203
Total Output
wineYield * count fTokens-on patches with [ageVines > 3]
17
1
11
