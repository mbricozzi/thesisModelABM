...
[
  ...
  countdown             ; Used in the Institutional change process
  ballotBox
  historyVotes
    ...
    [
      ...
      [
        ...
        [   ; When it is not they will decide based on their memory
          if precision myQuality prec < (ifelse-value memoryType = "goodOldDays" [goodOldDays] [meanPV])
          [
            set ballot -1
            set ballotBox insert-item (length ballotBox) ballotBox ballot
          ]

          if precision myQuality prec > (ifelse-value memoryType = "goodOldDays" [goodOldDays] [meanPV] ) and higherStandard < precision (myQuality) prec    ; You want to avoid that they increase the standard and they cannot even respect it.
          [
            set ballot 1
            set ballotBox insert-item (length ballotBox) ballotBox ballot
          ]
...
"" ""
PENS
"AVG Cap" 1.0 0 -16777216 true "" "plot mean [capital] of farms"
...
598
vineyards
ask patches with [any? ftokens-here] \n[set pcolor palette:scale-scheme \"Sequential\" \"Oranges\" 4 ageVines 0 20]
NIL
1
T
OBSERVER
